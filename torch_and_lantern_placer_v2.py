...
from block_exclusions import WATER_STATES, WATER_STATES_ALL, LAVA_STATES, GRAVEL, is_vegetation, is_non_solid
        ...
        for block in true_blocks:
            ...
            if place_torch:
                ...
                if block_choice == "lantern":
                    ...
                    # If there is a solid block above, place a hanging lantern.
                    if not is_non_solid(air_test_up.blockstate):
                    ...
                    elif not is_non_solid(air_test_down.blockstate):
...
export = {
    "name": "Place Lights",  # the name of the plugin
